...
public class LabQueue04 {
	...
	public static void printFile() {
		// write your code below here
		System.out.print(q_printer.peek() != null ? "Printing: " + q_printer.poll() + "\n" : "");
		System.out.println(q_printer.peek() == null ? "No file in queue" : "Printer queue => " + q_printer);
