...
public class Lab203 {
	public static void main(String[] args) {
		...
		public static String[] addArraySize(String[] subjects) {
			String[] subjectsNew = {"ITE-201", "BIS-112", "DAT-201", "JPN-201", "ENL-211",null};
			return subjectsNew;
		}
		public static String[] deleteElement(int index, String[] subjects) {
			String[] subjectsNew = new String[subjects.length-1];
			
			for(int i = 0; i <index;i++) {
				subjectsNew[i] = subjects[i];
			}
			
			for(int i = index;i<subjectsNew.length;i++) {
				subjectsNew[i] = subjects[i+1];
			}
			return subjectsNew;
		}
...
>>>>>>> c9604fc72e15acefa4189693df60459660935ae1
}